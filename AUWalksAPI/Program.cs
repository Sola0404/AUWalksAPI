...
var logger = new LoggerConfiguration()
    .WriteTo.Console()
    .WriteTo.File("Logs/AuWalks_Log.txt", rollingInterval: RollingInterval.Day)
...
{
    options.SwaggerDoc("v1", new OpenApiInfo { Title = "AUWalksAPI", Version = "v1" });
...
builder.Services.AddIdentityCore<IdentityUser>()
    ...
    .AddTokenProvider<DataProtectorTokenProvider<IdentityUser>>("AUWalks")
    .AddEntityFrameworkStores<AUWalksAuthDbContext>()
